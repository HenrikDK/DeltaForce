...
public class MsSqlDialectTest
{
    ...
    public void Setup()
    {
        _configuration = new ConfigurationBuilder()
            ...
            .AddJsonFile("appsettings.mssql.json", optional: false, reloadOnChange: true)
            .Build();
    ...
    public void Should_check_if_schema_exists()
    {
        ...
        if (check)
        {
            scriptRepository.Apply(
@"drop table DeltaForce.State;
drop table DeltaForce.Script;
drop schema DeltaForce;");
        }
...
drop schema DeltaForce;");
    ...
    public void Should_apply_a_script()
    {
        ...
        scriptRepository.Apply("select current_timestamp;");
    }
