...
public class PgSqlDbDialectTest
{
    ...
    public void Setup()
    {
        _configuration = new ConfigurationBuilder()
            ...
            .AddJsonFile("appsettings.pgsql.json", optional: false, reloadOnChange: true)
            .Build();
    ...
    public void Should_check_if_schema_exists()
    {
        ...
        if (check)
        {
            scriptRepository.Apply("drop schema deltaforce cascade;");
        }
